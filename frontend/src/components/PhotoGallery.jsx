      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className="flex justify-center items-center py-16">
          <div className="text-center">
            ...
            <p className="text-slate-600 text-lg">Loading photos...</p>
          </div>
        </div>
      </div>
    );
        ...
        {photos.length > 0 ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
            {photos.map((photo, index) => (
              <Card 
                key={index}
                className="cursor-pointer hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden border-0 bg-white group"
              ...
              >
                <div className="aspect-square relative">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-br from-slate-100 to-slate-200 items-center justify-center text-center text-slate-600 hidden">
                    <div>
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (currentIndex >= 0 && currentIndex < alternatives.length - 1) {
                  ...
                  fallback.className = 'bg-white rounded-lg p-8 max-w-md mx-auto text-center';
                  fallback.innerHTML = `
                    <div class="w-16 h-16 text-slate-600 mx-auto mb-4 flex items-center justify-center">
                      <svg class="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path>
                      </svg>
                    </div>
                    <h3 class="text-xl font-semibold text-slate-800 mb-2">Photo ${selectedIndex + 1}</h3>
                    <p class="text-slate-600 mb-6">Click the button below to view this photo in Google Drive.</p>
                  `;
